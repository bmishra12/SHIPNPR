...
namespace ShiptalkWeb
{
    public static class PasswordValidation
    {
        ...
        public static bool DoesTextContainsFirstLastName(string pwdText, string firstName, string lastName, string middleName)
        {
            ...
            if (middleName.Length > 3 && pwdText.Contains(middleName))
            {
                return true;
            }
