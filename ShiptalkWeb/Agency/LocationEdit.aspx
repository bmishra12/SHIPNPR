<%@ Page Title="" Language="C#" MasterPageFile="~/ShiptalkWeb.Master" AutoEventWireup="true" CodeBehind="LocationEdit.aspx.cs" Inherits="ShiptalkWeb.Agency.LocationEdit" %>
...
<asp:Content ID="contentBody" ContentPlaceHolderID="body1" runat="server">
    <div id="maincontent">
        <div class="dv3col">
                <asp:FormView runat="server" ID="formViewAgencyLocation" DataSourceID="dataSourceEditAgencyLocation" DataKeyNames="Id" DefaultMode="Edit" Width="100%">
                    <EditItemTemplate>
                      <h1>
                        Edit
                            ...
                            <table class="formTable">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="dropDownListState" DataTextField="Value" DataValueField="Key" DataSource='<%# States %>' SelectedValue='<%# Bind("PhysicalState") %>' AutoPostBack="true" OnSelectedIndexChanged="dropDownListState_SelectedIndexChanged" Enabled='<%# (Scope == Scope.CMS && IsAdmin) %>'>
                                            </asp:DropDownList>
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorLocationName" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="LocationName" ControlToValidate="textBoxLocationName" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                    <tr>
                                    <td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorPhysicalAddress1" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="PhysicalAddress1" ControlToValidate="textBoxPhysicalAddress1" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorPhysicalAddress2" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="PhysicalAddress2" ControlToValidate="textBoxPhysicalAddress2" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorPhysicalCity" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="PhysicalCity" ControlToValidate="textBoxPhysicalCity" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorPhysicalZip" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="PhysicalZip" ControlToValidate="textBoxPhysicalZip" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorMailingAddress2" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="MailingAddress2" ControlToValidate="textBoxMailingAddress2" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorMailingCity" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="MailingCity" ControlToValidate="textBoxMailingCity" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorMailingState" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="MailingState" ControlToValidate="dropDownListMailingState" RulesetName="Data" CssClass="required" OnValueConvert="proxyValidatorMailingState_ValueConvert" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorMailingZip" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="MailingZip" ControlToValidate="textBoxMailingZip" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorContactMiddleName" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="ContactMiddleName" ControlToValidate="textBoxContactMiddleName" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorContactLastName" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="ContactLastName" ControlToValidate="textBoxContactLastName" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                            <asp:Label runat="server" ID="labelContactTitle" AssociatedControlID="textBoxContactTitle" Text="Title:"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="textBoxContactTitle" MaxLength="50" Text='<%# Bind("ContactTitle") %>'></asp:TextBox>
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorContactTitle" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="ContactTitle" ControlToValidate="textBoxContactTitle" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorHoursOfOperation" runat="server" ControlToValidate="textBoxHoursOfOperation" CssClass="required" Display="Dynamic" DisplayMode="List" PropertyName="HoursOfOperation" RulesetName="Data" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorPrimaryPhone" runat="server" ControlToValidate="textBoxPrimaryPhone" CssClass="required" Display="Dynamic" DisplayMode="List" PropertyName="PrimaryPhone" RulesetName="Data" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" OnValueConvert="proxyValidatorPhoneNumber_ValueConvert" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorPrimaryEmail" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="PrimaryEmail" ControlToValidate="textBoxPrimaryEmail" RulesetName="Data" CssClass="required" OnValueConvert="proxyValidatorEmptyStringToNull_ValueConvert" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorTollFreePhone" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="TollFreePhone" ControlToValidate="textBoxTollFreePhone" RulesetName="Data" CssClass="required" OnValueConvert="proxyValidatorPhoneNumber_ValueConvert" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorTDD" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="TDD" ControlToValidate="textBoxTDD" RulesetName="Data" CssClass="required" OnValueConvert="proxyValidatorPhoneNumber_ValueConvert" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorTollFreeTDD" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="TollFreeTDD" ControlToValidate="textBoxTollFreeTDD" RulesetName="Data" CssClass="required" OnValueConvert="proxyValidatorPhoneNumber_ValueConvert" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorFax" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="Fax" ControlToValidate="textBoxFax" RulesetName="Data" CssClass="required" OnValueConvert="proxyValidatorPhoneNumber_ValueConvert" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <pp:PropertyProxyValidator ID="proxyValidatorComments" runat="server" Display="Dynamic" DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" PropertyName="Comments" ControlToValidate="textBoxComments" RulesetName="Data" CssClass="required" />
                                        </td>
                                    </tr>
                                     <%--Added by Lavanya--%>
                                    <tr>
        ...
        <pp:ObjectContainerDataSource ID="dataSourceEditAgencyLocation" runat="server" DataObjectTypeName="ShiptalkLogic.BusinessObjects.UI.EditAgencyLocationViewData" OnSelecting="dataSourceEditAgencyLocation_Selecting" OnUpdated="dataSourceEditAgencyLocation_Updated" OnUpdating="dataSourceEditAgencyLocation_Updating" />
</asp:Content>
