...
{
    public partial class LocationEdit : Page, IRouteDataPage, IAuthorize
    {
        ...
        private EditAgencyLocationViewData _viewData;

        private EditAgencyLocationViewData ViewData
        {
            get
            {
                if (_viewData == null)
                    _viewData = Logic.GetEditAgencyLocation(Id.Value);
        ...
        {
            Validate();
            formViewAgencyLocation.UpdateItem(true);
        }
        ...
        {
            return (AccountInfo.Scope == Scope.CMS || AccountInfo.StateFIPS == new State(ViewData.PhysicalState).Code);
        }
