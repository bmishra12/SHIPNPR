...
{
    public partial class PendingUserRegistrations : System.Web.UI.Page, IRouteDataPage
    {

        protected bool IncludeAllPendingEmailVerifications = false;
        private bool IsViewDataLoaded = false;
        private const string VIEWSTATE_KEY_INCL_PENDING_EMAILS = "INCL_PEND_EMAILS";

        protected void Page_Init(object sender, EventArgs e)
        {
            pager.PagedControlID = listViewPendingUsers.UniqueID;
        }
