...
{
    public partial class InActiveUserList : Page, IRouteDataPage
    {
        ...
        {
            if (SearchByState)
                return StepUpData(UserBLL.GetAllInactiveUsers(UserId, ddlStates.SelectedValue));
            //return GetCleanData(UserBLL.GetAllUsers(UserId, ddlStates.SelectedValue));
            else
                return StepUpData(UserBLL.GetAllInactiveUsers(UserId, string.Empty));
        ...
        //    FilterByStates.Visible = IsAnAdminUser;
        //    if (IsAnAdminUser)
        //        PopulateStates();
