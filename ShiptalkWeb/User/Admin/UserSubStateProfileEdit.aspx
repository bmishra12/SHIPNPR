<%@ Page Language="C#" MasterPageFile="~/ShiptalkWeb.Master" AutoEventWireup="true"
    CodeBehind="UserSubStateProfileEdit.aspx.cs" Inherits="ShiptalkWeb.UserSubStateProfileEdit"
    Title="User Sub State Profile - Edit" %>
    ...
    <script language="javascript" type="text/javascript">
		    ...
		    function HandleIsAdminClick(IsAdminClientId, ApproverPanelClientId)
            {
                ...
                if(chkIsAdmin != null)
                {
                        ...
                        var Elem = document.getElementById('divApprovePanel');
                        if(Elem != null)
                        {
                            //set value here                
...
<asp:Content ID="Content2" ContentPlaceHolderID="body1" runat="server">
    <div id="maincontent">
        <div class="dv3col" runat="server" id="plhMessage" visible="false" enableviewstate="false">
            ...
            <br />
            <asp:HyperLink ID="hlBackToEdit" runat="server" Visible="true" EnableViewState="false">Back to the Edit User Profile main page</asp:HyperLink>
        </div>
        <div class="dv3col" runat="server" id="MainPanel">
            ...
            <div style="text-align: left">
                <h2>
                    <asp:Label ID="lblTitle" runat="server" Text='Edit User Sub State Profile' EnableViewState="false"></asp:Label>
                </h2>
                <span class="smaller">
                    <asp:Literal ID="dv3colMessage" runat="server" Text='<%# "Edit admin rights, default settings, task functions and access authorizations, supervisors for " + GetUserFullName.EncodeHtml().ToCamelCasing() + " at " + GetSubStateRegionName.EncodeHtml().ToCamelCasing() + "." %>'
                        EnableViewState="false"></asp:Literal>
                </span>
            </div>
            <asp:FormView runat="server" ID="formView" DataSourceID="dataSourceSubStateUserEdit"
                Width="100%" DefaultMode="Edit" DataKeyNames="Id">
                <EditItemTemplate>
                        ...
                        <div id="dv3colFormContent" runat="server" style="margin-top: 10px; width: 615px;
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="c305">
                                        <asp:Label ID="SubStateName" runat="server" Text='<%# Eval("RegionName").EncodeHtml().ToCamelCasing() %>'
                                            CssClass="InfoValueFont" Width="256px"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 200px; text-align: right;">
                                        <asp:Label ID="Label4" runat="server" Text="Grant Access to this Region" AssociatedControlID="AccessStatusCheckbox"></asp:Label>
                                    </td>
                                    <td style="width: 4px">
                                        &nbsp;
                                    </td>
                                ...
                                <div id="pnlCanApproveUsers" runat="server" visible="true">
                                    <div id="divApproverPanel" style="display: block">
                                        <tr>
                                            ...
                                            <td class="c305">
                                                <asp:CheckBox ID="cbIsApprover" runat="server" Checked='<%# Bind("IsApproverDesignate") %>' Enabled='<%# EnableApproverCheckbox %>'
                                                    ValidationGroup="UserSubStateProfile" />
                                            </td>
                                        </tr>
                                    </div>
                                </div>
                                <div id="pnlIsSuperEditor" runat="server" visible="true">
                                    <div id="div2" style="display: block">
                                        <tr>
                                            ...
                                            <td class="c305">
                                                <asp:CheckBox ID="cbIsSuperDataEditor" runat="server" Checked='<%# Bind("IsSuperDataEditor") %>' ValidationGroup="UserSubStateProfile" />
                                            </td>
                                        </tr>
                                    </div>
                                </div>
                                <tr>
                                    ...
                                    <td style="width: 200px; text-align: right;">
                                        <asp:Label ID="Label2" runat="server" Text="Task Functions and Access Authorizations" AssociatedControlID="Descriptors"></asp:Label>
                                    </td>
                                    <td style="width: 4px">
                                        &nbsp;
                                    </td>
    ...
    <pp:ObjectContainerDataSource ID="dataSourceSubStateUserEdit" runat="server" DataObjectTypeName="ShiptalkLogic.BusinessObjects.UserRegionalAccessProfile"
        OnSelecting="dataSourceSubStateUserEdit_Selecting" OnUpdated="dataSourceSubStateUserEdit_Updated"
        OnUpdating="dataSourceSubStateUserEdit_Updating" />
</asp:Content>
