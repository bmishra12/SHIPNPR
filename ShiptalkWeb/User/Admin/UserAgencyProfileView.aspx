<%@ Page Language="C#" MasterPageFile="~/ShiptalkWeb.Master" AutoEventWireup="true"
    CodeBehind="UserAgencyProfileView.aspx.cs" Inherits="ShiptalkWeb.UserAgencyProfileView"
    Title="User Profile : Agency Profile : View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body1" runat="server">
    <div id="maincontent">
        <div class="dv3col" runat="server" id="MainPanel">
            <asp:FormView runat="server" ID="formView" DataSourceID="dataSourceAgencyUserView"
                Width="100%">
                <ItemTemplate>
                    <div style="text-align: left">
                        <h2>
                            <asp:Label ID="lblTitle" runat="server" Text='<%# "Agency profile for " + GetUserFullName %>'
                                EnableViewState="false"></asp:Label>
                        </h2>
                        <span class="smaller">
                            <asp:Literal ID="dv3colMessage" runat="server" Text='<%# "View admin rights, default settings, task functions and access authorizations, supervisors for " + GetUserFullName + " at " + GetAgencyName + "." %>'
                                EnableViewState="false"></asp:Literal>
                        </span>
                    </div>
                    <asp:Panel ID="AgencyDataPanel" runat="server" EnableViewState="false" DefaultButton="btnEdit">
                        <asp:PlaceHolder ID="plhEditDeleteCommands" runat="server" Visible='<%# IsEditAccessAllowed %>'>
                            <div class="commands">
                                <asp:Button runat="server" ID="btnEdit" Text="Edit" ToolTip="Edit this agency profile."
                        ...
                        <div id="dv3colFormContent" runat="server" style="margin-top: 10px; width: 615px;
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 305px">
                                        <asp:Label ID="AgencyName" runat="server" Text='<%# GetAgencyName %>' CssClass="InfoValueFont"
                                            Width="256px"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 200px; text-align: right;">
                                        <asp:Label ID="Label8" runat="server" Text="Grant Access to this Agency" ></asp:Label>
                                    </td>
                                    <td style="width: 4px">
                                        &nbsp;
                                    </td>
                                    <td style="width: 305px">
                                        <span class="InfoValueFont">
                                            <img alt="ActiveOrInactiveImage" runat="server" id="AccessStatus" src='<%# this.ResolveUrl("~/images/" + (((bool)Eval("IsActive")) ? "activestatus.png" : "inactivestatus.png"))  %>'>&nbsp;<%# ((bool)Eval("IsActive"))? "Active" : "Inactive" %></img>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <asp:PlaceHolder ID="plhIsMultiAgencyUser" runat="server" Visible='<%# (bool)IsMultiAgencyUser %>'>
                                    <tr>
                                        <td style="width: 8px;">
                                        </td>
                                        <td style="width: 200px; text-align: right;">
                                            <asp:Label ID="Label3" runat="server" Text="Is Default Agency" ></asp:Label>
                                        </td>
                                        <td style="width: 4px">
                                            &nbsp;
                                        </td>
                                ...
                                <asp:PlaceHolder ID="plhCanApproveUsers" runat="server" Visible='<%# (bool)Eval("IsAdmin") %>'>
                                    <tr>
                                        ...
                                        <td style="width: 200px; text-align: right;">
                                            <asp:Label ID="Label6" runat="server" Text="Can approve user registrations" ></asp:Label>
                                        </td>
                                        <td style="width: 4px">
                                            &nbsp;
                                        </td>
    ...
    <pp:ObjectContainerDataSource ID="dataSourceAgencyUserView" runat="server" DataObjectTypeName="ShiptalkLogic.BusinessObjects.UserRegionalAccessProfile"
        OnSelecting="dataSourceAgencyUserView_Selecting" />
</asp:Content>
