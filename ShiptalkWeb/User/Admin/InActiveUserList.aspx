<%@ Page Language="C#" MasterPageFile="~/ShiptalkWebWide.Master" AutoEventWireup="true"
    CodeBehind="InActiveUserList.aspx.cs" Inherits="ShiptalkWeb.InActiveUserList" Title="List of InActive Users" %>
    ...
    <div id="maincontentwide">
         <div class="dv5col">
            <div style="text-align: left">
                <h1>
                    View / Download 180 Days Inactive User List</h1>
            </div>
            <span class="smaller">
               ...
               <asp:Panel ID="AdminLinksPanel" runat="server">
                ...
                <div id="dv3colFormContent">
                    <asp:ListView runat="server" ID="listViewUsers" DataSourceID="dataSourceUsers" ItemPlaceholderID="placeHolder"
                        ...
                        onselectedindexchanged="listViewUsers_SelectedIndexChanged" OnItemCommand="listViewUsers_OnItemCommand">
                ...
                CommandArgument='<%#Eval("UserId").EncodeHtml() %>' />
                              ...
                              <%--  <td style="vertical-align: top">
                                <!-- Prakssh -->
                                      <span style="font-size: 14px"><a id="A1" runat="server" href='<%# RouteController.UserView((int)Eval("UserId")) %>'
                                ...
                                <td style="vertical-align: top">
                                    <span style="font-size: 14px"><a id="A2" runat="server" href='<%# RouteController.UserView((int)Eval("UserId")) %>'
                                        ...
                                        <%# ((int)Eval("UserId")).ToString() %></a> </span>
                                </td>--%>
                            </tr>
                        </ItemTemplate>
                    </asp:ListView>
