<%@ Page Language="C#" MasterPageFile="~/ShiptalkWeb.Master" AutoEventWireup="true"
    CodeBehind="Inactivity180.aspx.cs" Inherits="ShiptalkWeb.Inactivity180" Title="Search Users" %>
    ...
    <div id="maincontent">
        <div class="dv3col">
            <div style="text-align: left">
                <h1>
                    Search 180 Days Inactive Users</h1>
            </div>
            <span class="smaller">
            ...
            <div>
              ...
              <div class="commands">
                 <a runat="server"    id="Inactivity180Link" href='<%# RouteController.InActiveUserList() %>' visible="false"> <b>180 Days Inactive User List</b></a>
               </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="tdFormLabel">
                                    <asp:Label runat="server" ID="label2" Text="Search 180 Days Inactive Users:" ToolTip="Search by name, phone or email"
                ...
                <div id="dv3colFormContent" class="section">
                    <asp:ListView runat="server" ID="listViewUsers" DataSourceID="dataSourceUsers" ItemPlaceholderID="placeHolder"
                        DataKeyNames="UserId"   
                        OnItemCommand="listViewUsers_OnItemCommand">
                        <LayoutTemplate>
                ...
                Text="Allow" 
                CommandName="Allow" 
                CommandArgument='<%#Eval("UserId").EncodeHtml() %>' />
