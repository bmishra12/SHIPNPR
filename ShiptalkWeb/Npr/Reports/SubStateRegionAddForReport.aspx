<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ShiptalkWeb.Master" CodeBehind="SubStateRegionAddForReport.aspx.cs" Inherits="NPRRebuild.ShiptalkWeb.NPRReports.SubStateRegionAddForReport" %>
...
<asp:Content ID="contentHead" ContentPlaceHolderID="head" runat="server">
    <title>Creat a new Sub State Region For Report</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body1" runat="server">
    <div id="maincontent">
        <div class="dv3col">
            <h1>
                Add a new Sub State Region For Report</h1>
            <div>
                <asp:FormView runat="server" ID="formViewSubStateRegionForReport" DataSourceID="dataSourceSubStateRegionForReport" DefaultMode="Insert" Width="100%">
                    <InsertItemTemplate>
                        <p>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <pp:PropertyProxyValidator ID="proxyValidatorState" runat="server" Display="Dynamic"
                                        DisplayMode="List" SetFocusOnError="true" SourceTypeName="ShiptalkLogic.BusinessObjects.UI.AddSubStateRegionForReportViewData"
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        ...
                                        AppendDataBoundItems="true" DataSource='<%# ReportFromeType %>' SelectedValue='<%# Bind("ReprotFormType") %>' AutoPostBack="true" OnSelectedIndexChanged="dropDownListFormType_SelectedIndexChanged">
                                 ...
                                 <tr>
                                    ...
                                    AppendDataBoundItems="true" DataSource='<%# ReportSubStateReportType %>' SelectedValue='<%# Bind("Type") %>' AutoPostBack="true" OnSelectedIndexChanged="dropDownListGroupType_SelectedIndexChanged">
                                            ...
                                            <table id="serviceAreas">
                                                    ...
                                                    <tr>
                                                        <td rowspan="2">
                                                            ...
                                                            <asp:ListBox ID="listBoxCounties" runat="server" SelectionMode="Multiple" DataTextField="Value" DataValueField="Key" DataSource='<%# DynamicSubStateRegions %>' CssClass="src dropdown1wm" Height="150px" Width="150px"></asp:ListBox>
                                                        </td>
                                                        ...
                                                        <td rowspan="2">
                                                            <asp:ListBox ID="listBoxServiceAreas" runat="server" SelectionMode="Multiple" CssClass="dst dropdown1wm" Height="150px" Width="150px" DataTextField="Value" DataValueField="Key" DataSource='<%# DynamicSubStateRegions %>'></asp:ListBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
    ...
    <pp:ObjectContainerDataSource ID="dataSourceSubStateRegionForReport" runat="server" DataObjectTypeName="ShiptalkLogic.BusinessObjects.UI.AddSubStateRegionForReportViewData" OnInserting="dataSourceSubStateRegion_Inserting" OnInserted="dataSourceSubStateRegion_Inserted" />
</asp:Content>
