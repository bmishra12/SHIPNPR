<%@ Page Title="" Language="C#" MasterPageFile="~/ShiptalkWebWide.Master" AutoEventWireup="true" CodeBehind="SpecialFieldsFAdd.aspx.cs" Inherits="ShiptalkWeb.Npr.Forms.SpecialFieldsFAdd" %>
...
<div class="dv5col">
    ...
    <table width="100%" cellspacing="10px" >
        <tr>
            ...
            <td><asp:TextBox ID="TxtName"  type="text" runat="server" ToolTip="Name"></asp:TextBox></td>
        ...
        <tr>
            ...
            <td colspan="3"><asp:Textbox ID="TxtDescription" runat="server"  MaxLength="100" Width="620px" ToolTip="Description" ></asp:Textbox></td>
            <td></td>
            <td></td>
        </tr>
        <tr>
             ...
             <td><asp:DropDownList ID="ddlValidationType" Width="200px" runat="server" ToolTip="Validation Type">
                ...
                <asp:ListItem Text="Option" />
                        ...
                        <td>
                            <asp:RadioButtonList ID="rdIsRequired" runat="server" RepeatDirection="Horizontal">
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <%--<asp:RegularExpressionValidator ID="regValidationRange" runat="server" Display="Dynamic" ControlToValidate="txtValidationRange" ></asp:RegularExpressionValidator>--%>
            </td>
        </tr> 
       <%-- end--%>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:Label ID="lblFeedBack" runat="server" ForeColor="Red"  Width="100%"></asp:Label>
            </td>
        </tr>
    </table>
